...
The methods to use it from the rust program are located [here](../../../zksync_os/src/main.rs); see  `NonDeterminismCSRSourceImplementation`, which is then used to implement the [`CsrBasedIOOracle`](../../../proof_running_system/src/io_oracle/mod.rs)).
